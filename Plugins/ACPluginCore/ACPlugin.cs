  ...
  internal class ACPlugin : Game
  {
    ...
    private struct Handshaker
    {
      ...
      public byte[] toByte()
      {
        ...
        byteList.AddRange(BitConverter.GetBytes(this.identifier));
        byteList.AddRange(BitConverter.GetBytes(this.version));
        byteList.AddRange(BitConverter.GetBytes(this.operationId));
