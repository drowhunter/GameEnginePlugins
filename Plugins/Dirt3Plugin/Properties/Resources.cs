...
namespace Dirt3Plugin.Properties
{
	...
	internal class Resources
	{
		...
		internal static ResourceManager ResourceManager
		{
			get
			{
				if (resourceMan == null)
				{
					ResourceManager resourceManager = resourceMan = new ResourceManager("Dirt3Plugin.Properties.Resources", typeof(Resources).Assembly);
				}
				return resourceMan;
			}
		}
